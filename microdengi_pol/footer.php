...
<div class="container">
        <div class="row">
            ...
            <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                <!-- <p class="footer-p">Serwis pomagający w wyborze korzystnej pożyczki online z siedzibą w 12 South Bridge, Suit 1, Edynburg, Szkocja, EH1 1DD, Wielka Brytania, telefon kontaktowy (tylko w języku angielskim). Pożyczka udzielana jest na sumę od 500 do 25 000 zł, na okres od 61 do 365 dni. Maksymalna stopa procentowa pożyczki wynosi 1,6% dziennie, a minimalna 0,49%. Przykładowa kalkulacja pożyczki: pożyczka 5 000 złotych na okres 10 tygodni z oprocentowaniem 0,49% dziennie; odsetki za cały okres pożyczki wyniosą 1 715 zł. Całkowita suma zadłużenia wyniesie 6 715 zł.</p>
...
{
    if (typeof yaCounter48027974 == 'undefined') return;
	if (typeof param == 'undefined') yaCounter48027974.reachGoal(target);
	else yaCounter48027974.reachGoal(target,param);
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-116603465-1"></script>
<script>
window.dataLayer = window.dataLayer || [];
function gtag(){dataLayer.push(arguments);}
gtag('js', new Date());

gtag('config', 'UA-116603465-1');
</script>
