...
else
{
    ...
    switch($this->uri->segment(1))
    {
        case 'about': 
            ...
            break;
        case 'documents': 
            $my_title = 'Polityka prywatności'; 
            $description = 'Serwis internetowy Kasaodzaraz.pl (“Serwis”) zgonie z Ustawą o ochronie danych osobowych z 29 sierpnia 1977 r. (Dz.U. z 2015';
            break;
        case 'faq': 
            $my_title = 'FAQ'; 
